...
# Creat a parser
parser = argparse.ArgumentParser(description="A command-line application with python to predict the class of given flower based on it is image")
...
def predict(image_path, model, top_k):
        ...
        model_predict = model.predict( expanded_image)
        top_k_probs, top_k_classes = tf.nn.top_k(model_predict, k=top_k)
